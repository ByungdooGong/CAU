...
{
	face_cascade_name = "C:\\Users\\cvm\\Desktop\\opencv\\sources\\data\\haarcascades\\haarcascade_frontalface_alt.xml";
...
void detectAndDisplay(Mat frame)
{
	...
	cvtColor(frame, frame_gray, COLOR_BGR2GRAY);  //BGR -> GRAY, 컬러변환 함수
	equalizeHist(frame_gray, frame_gray);  // frame_gray -> frame_gray, 히스토그램 평준화(contrast 강화)
